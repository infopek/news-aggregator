...
try {
  ...
  await page.getByText('Local text is similar to selected interests', { exact: true }).first().waitFor(); await page.getByText('Matches your optional age and a declared audience range', { exact: true }).first().waitFor()
