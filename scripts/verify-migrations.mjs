...
function assertPersistenceConstraints(db) {
  ...
  expectConstraint(db, 'INSERT INTO article_sources(article_id,source_id,external_id,first_seen_at_ms,last_seen_at_ms) VALUES (?,?,?,?,?)', 'article-2', 'api', 'reversed-time', 2, 1)
  ...
  expectConstraint(db, "INSERT INTO ranking_results(article_id,score,algorithm_version,calculated_at_ms) VALUES ('article-2',-0.1,'v1',1)")
  expectConstraint(db, "INSERT INTO ranking_results(article_id,score,algorithm_version,calculated_at_ms) VALUES ('article-2',1.1,'v1',1)")
  expectConstraint(db, "INSERT INTO ranking_contributions(article_id,ordinal,signal,raw_score,weight,weighted_score,reason_code) VALUES ('article-1',1,'interest',-0.1,.2,.1,'low')")
  expectConstraint(db, "INSERT INTO ranking_contributions(article_id,ordinal,signal,raw_score,weight,weighted_score,reason_code) VALUES ('article-1',1,'interest',1.1,.2,.1,'high')")
  expectConstraint(db, "INSERT INTO ranking_contributions(article_id,ordinal,signal,raw_score,weight,weighted_score,reason_code) VALUES ('article-1',1,'interest',.5,.2,-0.1,'low')")
  expectConstraint(db, "INSERT INTO ranking_contributions(article_id,ordinal,signal,raw_score,weight,weighted_score,reason_code) VALUES ('article-1',1,'interest',.5,.2,1.1,'high')")
  ...
  expectConstraint(db, "INSERT INTO refresh_runs(id,started_at_ms,finished_at_ms,status) VALUES ('reversed-time',10,9,'failed')")
